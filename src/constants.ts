...
// SAFETY-002 : « D&D » est une marque de Wizards of the Coast. Un libellé
// descriptif dit la même chose sans nommer une propriété protégée.
...
export const DEFAULT_DESIGNER_TEMPLATES = {
  ...
  combined: `Role: You are a Concept Artist using a "Style Transfer" workflow. Result: The subject described as a {input}, but painted as if it belongs in the universe of the reference images, combining their visual traits into one cohesive design, rendered in the style of a {style} illustration.\n\n{creativity}`,
...
CRITICAL - TMM METALLIC TEXTURE & HUE INSTRUCTIONS: For all metal parts (swords, armor trim, machinery), strictly use a True Metallic Metal (TMM) aesthetic. Do not use NMM techniques.
